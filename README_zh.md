...
![系统结构图](docs/assets/Structure.png)

**AI-Trader Ollama** 是一个完全自主的股票交易系统，使用 6 个专业 AI 代理来分析市场、做出交易决策和管理投资组合。代理通过多轮讨论协作，使用 28 个高级分析工具，并通过 RAG 内存系统从历史交易决策中学习。

**核心能力：**
- 🤖 **6 个 AI 代理**：市场分析师、技术分析师、基本面分析师、情绪分析师、风险分析师和交易代理
- 📊 **28 个分析工具**：实时市场数据、技术指标、基本面指标、新闻情绪和历史内存检索
- 🧠 **RAG 内存系统**：代理从过去的交易决策和市场模式中学习
- 📈 **NASDAQ-100 覆盖**：分析 118+ 个股票，提供全面的多视角分析
- 🎨 **实时仪表板**：实时监控代理讨论、投资组合表现和交易决策
- ⚡ **快速执行**：优化后可在 6-7 分钟内完成交易周期

> **配备 29 个高级工具 + 6 个专业 LLM 代理的多代理交易系统**  
