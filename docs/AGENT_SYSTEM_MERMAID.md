# 🔄 AI Trader Agent System - Mermaid Flowchart
...
```mermaid
graph LR
    subgraph Round1["Round 1: Market Data Collection"]
        MA1[Market Agent] --> MD1[Raw Market Data<br/>• Prices<br/>• VIX<br/>• Indicators]
    end
    
    subgraph Round2["Round 2: Analysis & Discussion"]
        MA2[Market Analyst] --> AN2[Market Analysis]
        AD2[Analyst Discussion] --> CON2[Consensus<br/>• Stance<br/>• Signals<br/>• Risk signals]
        AN2 --> CON2
    end
    
    subgraph Round3["Round 3: Risk Assessment"]
        RA3[Risk Analyst] --> RR3[Risk Report<br/>• Position risk<br/>• Control report<br/>• Recommendations]
        P3[Portfolio] --> RA3
    end
    
    subgraph Round4["Round 4: Trading Decision"]
        TA4[Trader Agent] --> TD4[Trading Decision<br/>• Buy/Sell orders<br/>• Prices<br/>• Quantities]
    end
    
    subgraph Round5["Round 5: Execution & Display"]
        EX5[Execution] --> P5[Portfolio Updated]
        P5 --> BD5[Backend Display<br/>• P&L<br/>• Trade history<br/>• Positions]
    end
    ...
    style Round1 fill:#ffe1f5
    style Round2 fill:#e1ffe1
    style Round3 fill:#fff4e1
    style Round4 fill:#ffe1f5
    style Round5 fill:#f0f0f0
```
...
graph TB
    subgraph Agents["Agent Roles"]
        MA[Market Agent<br/>Data Collector]
        MAN[Market Analyst<br/>Technical Analyst]
        AD[Analyst Discussion<br/>Consensus Builder]
        RA[Risk Analyst<br/>Risk Evaluator]
        TA[Trader Agent<br/>Decision Maker]
    end
...
**文档状态**: ✅ Mermaid 流程图已创建  
**更新日期**: 2025-11-02  
**说明**: 这些 Mermaid 图表可以在支持 Mermaid 的 Markdown 查看器中直接渲染
